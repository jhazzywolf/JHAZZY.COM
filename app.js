document.addEventListener('DOMContentLoaded', () => {
    ...
    // 1. Click the Wolf to reveal the bubble and jump
    if (wolf && bubble) {
    ...
    actionChips.forEach(chip => {
        chip.addEventListener('click', (e) => {
            ...
            if (action === 'music') {
                dialogueText.innerHTML = "Check out the <a href='music.html' style='color:#aaa; text-decoration:underline;'>Music tab</a> for my latest single 'Naughty'.";
